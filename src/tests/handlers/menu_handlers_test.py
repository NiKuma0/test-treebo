...
@pytest.mark.parametrize("user", [None, UserEntity(id=1, telegram_id=1, email='email', name='name')])
async def test_menu_handler(state: mock.Mock, answer_to: mock.Mock, user: UserEntity | None):
